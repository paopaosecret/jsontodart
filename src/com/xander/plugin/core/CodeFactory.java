...
public class CodeFactory {
    ...
    public static void main(String[] args) {
        ...
        generateDartByJson(null, json, "Auto");
    }
     ...
     */
    public static int generateDartByJson(VirtualFile file, String json, String key) {
        ...
        if (jsonElement != null && jsonElement.isJsonObject() && jsonElement.getAsJsonObject() != null) {
            parseJsonObject(file, jsonElement.getAsJsonObject(), key);
            return 0;
        } else if (jsonElement != null && jsonElement.isJsonArray() && jsonElement.getAsJsonArray() != null) {
            parseJsonArray(file, jsonElement.getAsJsonArray(), key);
            return 0;
        } else {
            return -1;
        }
     ...
     * @param classKey
     */
    private static void parseJsonObject(VirtualFile file, JsonObject json, String classKey) {
        ...
        for(Map.Entry<String, JsonElement> item : json.entrySet()){
            ...
            if(jsonElement.isJsonPrimitive()){
                ...
                generateDartByJson(file, item.getValue().toString(), StringUtils.firstToUpperCase(key));
        ...
        FileUtils.writeStringToFile(file.getPath(), sb.toString());
    }
     ...
     * @param classKey
     */
    private static void parseJsonArray(VirtualFile file, JsonArray json, String classKey) {
        ...
        generateDartByJson(file, jsonObject.toString(), classKey);
    }
}
